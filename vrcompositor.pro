...
LIBS += -lassimp -lfreeimage -lGL -lGLU -lGLEW -lboost_system -lboost_filesystem -ldl -lOVR
QT += opengl
...
HEADERS += src/window/window.h src/util/framecounter.h src/device/oculushmd.h
SOURCES += src/window/window.cpp src/util/framecounter.cpp src/device/oculushmd.cpp src/main.cpp